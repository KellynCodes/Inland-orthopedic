  ...
  const _TruncateDirective = class _TruncateDirective {
    ...
    toggleText() {
      ...
      if (text.length > this.maxLength) {
        ...
        const readMoreLink = this.el.nativeElement.createElement("a");
        readMoreLink.textContent = "Read More";
        readMoreLink.className = "cursor-pointer inline-block bg-[#003367] hover:bg-[#ee6565e6] text-white rounded-full px-3 py-1 text-sm font-semibold mb-2";
...
@angular/forms/fesm2022/forms.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-566MBGDJ.mjs.map
