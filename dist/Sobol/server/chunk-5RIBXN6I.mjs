  ...
  const _TruncateDirective = class _TruncateDirective {
    ...
    toggleText() {
      ...
      if (text.length > this.maxLength) {
        ...
        this.el.nativeElement.append(`<a href="about/detail" class="cursor-pointer inline-block bg-[#003367] hover:bg-[#ee6565e6] text-white rounded-full px-3 py-1 text-sm font-semibold mb-2">Read More</a>`);
      }
    }
  };
...
@angular/forms/fesm2022/forms.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-5RIBXN6I.mjs.map
